...
export default function HomePage() {
  ...
  return (
    <main style={{ minHeight: "100vh", background: "linear-gradient(135deg,#eff6ff,#f8fafc 45%,#eef2ff)", color: "#0f172a" }}>
      <AppHeader />
      <section style={{ maxWidth: 1100, margin: "0 auto", padding: "42px 20px 24px" }}>
        <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit,minmax(280px,1fr))", gap: 24, alignItems: "center" }}>
          <div>
            ...
            <p style={{ fontSize: 17, lineHeight: 1.9, color: "#475569", maxWidth: 620 }}>
              N3・N2学習、ゲーム、AI会話、AIスピークをひとつにまとめた販売用学習アプリです。個人は1日無料体験、企業コード登録ユーザーは支払い不要で利用できます。
            </p>
            <div style={{ display: "flex", gap: 12, flexWrap: "wrap", marginTop: 24 }}>
              {loading ? null : user ? (
                <>
                  <button onClick={() => router.push("/select-mode")} style={primaryBtn}>学習を始める</button>
                ...
                <>
                  <Link href="/register" style={primaryLink}>無料体験を始める</Link>
          ...
          <div style={{ background: "rgba(255,255,255,.82)", border: "1px solid rgba(148,163,184,.25)", borderRadius: 28, padding: 22, boxShadow: "0 24px 60px rgba(15,23,42,.12)" }}>
            <h2 style={{ marginTop: 0 }}>入っている機能</h2>
